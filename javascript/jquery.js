...
(function(global, factory) {
          ...
          if (documentIsHTML) {
            ...
            if (support.qsa &&
              ...
              if (nodeType !== 1) {
                ...
                i = groups.length;
                nidselect = ridentifier.test(nid) ? "#" + nid : "[id='" +
                  nid + "']";
                while (i--) {
  ...
  function curCSS(elem, name, computed) {
    ...
    if ((ret === "" || ret === undefined) && !jQuery.contains(elem.ownerDocument,
        elem)) {
    ...
    ajax: function(url, options) {
      ...
      if (s.crossDomain == null) {
        ...
        try {
          ...
          s.crossDomain = originAnchor.protocol + "//" + originAnchor
            .host !==
  ...
  jQuery.expr.filters.visible = function(elem) {
    ...
    return elem.offsetWidth > 0 || elem.offsetHeight > 0 || elem.getClientRects()
      .length > 0;
  };
